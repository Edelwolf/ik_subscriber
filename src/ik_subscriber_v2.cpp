   ...
   std::string new_content = read_pose_file("path/to/your/pose.txt");
    ...
    geometry_msgs::msg::Pose parse_pose_from_content(const std::string& content) {
        ...
        while (std::getline(stream, line)) {
            ...
            if (key.find("position_x") != std::string::npos) {
                pose.position.x = value;
            } else if (key.find("position_y") != std::string::npos) {
                pose.position.y = value;
            } else if (key.find("position_z") != std::string::npos) {
                pose.position.z = value;
            } else if (key.find("orientation_x") != std::string::npos) {
                pose.orientation.x = value;
            } else if (key.find("orientation_y") != std::string::npos) {
                pose.orientation.y = value;
            } else if (key.find("orientation_z") != std::string::npos) {
                pose.orientation.z = value;
            } else if (key.find("orientation_w") != std::string::npos) {
